...
**✔ 녹색 테마를 선택한 이유**
- **사용자 눈의 피로를 최소화하는 컬러 스킴**로 구성하기 위해 녹색 기반의 테마로 정했습니다. 고채도 색상보다 시각적 부담이 덜하면서 장시간 사용하는 관리자 대시보드 용도에 적합하다고 판단했습니다.
- 올페이즈 채용 공고의 포스터 색상에서 착안했습니다. 서비스의 **브랜드 아이덴티티와 일관되도록** 방향을 잡았습니다.
- 녹색은 지폐의 색이기도 하며 긍정, 성공, 안정감을 의미하는 대표적 색상입니다. **데이터 신뢰성과 안정성을 강조**하는 데에 도움이 되는 색상이기에 결정했습니다.
...
- 가맹점 목록 조회 페이지 : 전체 가맹점 정보를 조회할 수 있도록 확장  
- 가맹점 상세 페이지를 추가해 가맹점별 필터링·지표 분석 기능 제공  
- 차트 반응형/상호작용 강화 필요  
